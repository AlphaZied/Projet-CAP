...
function didactiel(){
	...
	clearInterval(inter);
	i=0;
	speak_initialisation("Bienvenue petit! La situation est simple. Afin d'envahir la planète B8-RT65, plus communément appellée la Terre,", "dialogue");
}
...
function pass_scenar(){
	...
	if(count_scenar == 3){
	speak_initialisation("Tout est claire ? Ne perdons pas de temps, commencez par tester le simulateur. En éspérons que vous n'êtes pas trop nul.", "dialogue");
	}
	if(count_scenar == 4){
		disap_perso();
	}
